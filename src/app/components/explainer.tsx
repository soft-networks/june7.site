...
const Explainer = () => {
    ...
    return (
        <div className={modalCSS}>
            <div className="h2">help me make this website today!</div>
            <p>my name is bhavik, and i love building websites with people. today i'm building this website from scratch — with you and many (maybe hundreds?) of other people.</p>
